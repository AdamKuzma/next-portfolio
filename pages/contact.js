  ...
  <>
    <div className='container'>
      <div className='contacts mt-36 mx-4 lg:mx-0 flex flex-col'>
        ...
        <p className='fade-in delay-4'><a href='https://github.com/AdamKuzma' target='_blank' rel='noopener noreferrer'>GitHub</a></p>
        <p className='fade-in delay-5'><a href='https://www.linkedin.com/in/adamkuzma/' target='_blank' rel='noopener noreferrer'>LinkedIn</a></p>
      </div>
    </div>
  </>
);
