  ...
  return (
    <div className='container mx-auto'>
      ...
      <div className='lg:flex lg:gap-20'>
        ...
        <div className='lg:w-1/2 items-start fade-in delay-3'>
      ...
      <div className='flex flex-col lg:flex-row gap-8 lg:gap-10 mb-14 mt-14 py-8 px-8 lg:py-12 lg:px-12 bg-[#F2F2F4] rounded-xl'>
      ...
      <p className='mb-0 lg:mb-8 lg:w-3/5 fade-in delay-2'>
      ...
      <div className='lg:mb-14 mt-14 pt-8 px-8 lg:pt-12 lg:px-12 bg-[#F2F2F4] rounded-xl'>
      ...
      <div className='mb-14 mt-14 px-12 py-8 lg:py-12 lg:px-28 bg-[#F2F2F4] rounded-xl'>
      ...
      <div className='mb-4 mt-4 lg:mt-14 px-6 py-8 lg:py-12 lg:px-12 bg-[#F2F2F4] rounded-xl'>
      ...
      <div className='mb-14 lg:mt-14 px-6 py-8 lg:py-12 lg:px-12 bg-[#F2F2F4] rounded-xl'>
      ...
      <div className='mb-14 mt-4 lg:mt-14 py-8 px-6 lg:py-12 lg:px-12 bg-[#F2F2F4] rounded-xl'>
