...
function MemberRewards() {
    ...
    <div className='container mx-auto'>
      ...
      />
        ...
        <p className='mb-4 lg:w-3/5 fade-in delay-2 '>
      ...
      <p className='mb-12 lg:w-3/5 fade-in delay-2'>
      ...
      <div className='mb-14 py-12 px-4 lg:py-12 lg:px-12 bg-neutral-100 rounded-lg'>
      ...
      <div className='flex flex-col lg:flex-row gap-16 lg:gap-10 mb-12 py-12 px-6 lg:py-12 lg:px-12 bg-neutral-100 rounded-lg'>
        <div className='flex-1'>
      ...
      <div className='lg:flex lg:gap-16 mb-14'>
        ...
        <div className='lg:w-1/2 py-8 px-12 lg:py-12 lg:px-24 bg-neutral-100 rounded-lg'>
      ...
      <div className='lg:flex lg:gap-20 mb-12'>
        <div className='lg:w-1/2'>
      ...
      <div className='mb-12 py-12 px-6 lg:py-12 lg:px-12 bg-neutral-100 rounded-lg'>
      ...
      <div className='mb-12 py-12 px-0 lg:py-12 lg:px-12 bg-neutral-100 rounded-lg'>
